...
const findSpiderMan = function(superheroes) {
    return superheroes.find((superheroes) => {
...
//of 
const doubleArrayValues = function(x) {
    return x.map(n => n * 2) //of (n => n + n)
};
console.log((doubleArrayValues([1, 2, 3]))); 
...
//D In een array met strings. Schrijf een JavaScript functie die kijkt of er een bepaalde string: "Italy" in de array aanwezig is. => includes!!
...
const bigSum = function(accumulator, number) {
